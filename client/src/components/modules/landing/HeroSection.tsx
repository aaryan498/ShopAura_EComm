...
const HeroSection = () => {
  return (
    <section className="relative h-[70vh] md:h-[80vh] flex items-center justify-center text-center overflow-hidden bg-gradient-to-br from-indigo-500 to-purple-600 dark:from-gray-800 dark:to-gray-900">
      {/* Background overlay for premium feel */}
      <div className="absolute inset-0 bg-black opacity-30 dark:opacity-50 z-0"></div>
      ...
      <div className="relative z-10 p-4 max-w-4xl mx-auto">
        ...
        <motion.p
          ...
          className="text-lg md:text-xl text-indigo-100 dark:text-gray-300 mb-8 max-w-2xl mx-auto"
        >
